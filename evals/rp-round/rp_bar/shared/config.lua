...
-- Mixing a drink: a UI-kit progress bar plus, when the server can play it, an RP
-- animation profile from the catalogue (`give` = "Offer an item", `drink` = "Drink from
-- a can", `barlean` = "Lean on a counter"). Set `profile = false` for no animation.
RpBarConfig.craft = {
    durationMs = 4000,
    profile = "give",
}
