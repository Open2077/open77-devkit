...
> Plan complet v2 : 30 ressources sur l'inventaire réel de la plateforme, 12 métiers dont 5 avec runs (5 phases, une ligne `/goal` par script) : https://claude.ai/artifact/6HK6VJpSay4WAKc5eybaLG — copie locale `PLAN.html`.
